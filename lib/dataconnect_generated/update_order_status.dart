...
class UpdateOrderStatusVariablesBuilder {
  ...
  UpdateOrderStatusVariablesBuilder(this._dataConnect, {required  this.orderId,required  this.newStatus,});
  ...
  MutationRef<UpdateOrderStatusData, UpdateOrderStatusVariables> ref() {
    UpdateOrderStatusVariables vars= UpdateOrderStatusVariables(orderId: orderId,newStatus: newStatus,);
...
class UpdateOrderStatusVariables {
  ...
  newStatus = nativeFromJson<String>(json['newStatus']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    newStatus == otherTyped.newStatus;
    
  }
  @override
  int get hashCode => Object.hashAll([orderId.hashCode, newStatus.hashCode]);
  

  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    json['orderId'] = nativeToJson<String>(orderId);
    json['newStatus'] = nativeToJson<String>(newStatus);
    return json;
  }
